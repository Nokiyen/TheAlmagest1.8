package noki.almagest.render.tile;
 ...
 */
public class RenderTileConstellation extends TileEntitySpecialRenderer {
...
//	private boolean flag = false;
	...
	//******************************//
	@Override
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float partialTickFrame, int destroy) {
...
//		double size = 0.5;
		...
		renderer.addVertexWithUV(minX, minY, minZ, 0, 0);
		renderer.addVertexWithUV(minX, maxY, minZ, 0, 1);
		renderer.addVertexWithUV(maxX, maxY, minZ, 1, 1);
		renderer.addVertexWithUV(maxX, minY, minZ, 1, 0);
		
		renderer.addVertexWithUV(minX, minY, maxZ, 0, 0);
		renderer.addVertexWithUV(maxX, minY, maxZ, 1, 0);
		renderer.addVertexWithUV(maxX, maxY, maxZ, 1, 1);
		renderer.addVertexWithUV(minX, maxY, maxZ, 0, 1);
		
		renderer.addVertexWithUV(minX, minY, minZ, 0, 0);
		renderer.addVertexWithUV(maxX, minY, minZ, 0, 1);
		renderer.addVertexWithUV(maxX, minY, maxZ, 1, 1);
		renderer.addVertexWithUV(minX, minY, maxZ, 1, 0);
		
		renderer.addVertexWithUV(minX, maxY, minZ, 0, 0);
		renderer.addVertexWithUV(minX, maxY, maxZ, 1, 0);
		renderer.addVertexWithUV(maxX, maxY, maxZ, 1, 1);
		renderer.addVertexWithUV(maxX, maxY, minZ, 0, 1);
		
		renderer.addVertexWithUV(minX, minY, minZ, 0, 0);
		renderer.addVertexWithUV(minX, minY, maxZ, 0, 1);
		renderer.addVertexWithUV(minX, maxY, maxZ, 1, 1);
		renderer.addVertexWithUV(minX, maxY, minZ, 1, 0);
		
		renderer.addVertexWithUV(maxX, minY, minZ, 0, 0);
		renderer.addVertexWithUV(maxX, maxY, minZ, 1, 0);
		renderer.addVertexWithUV(maxX, maxY, maxZ, 1, 1);
		renderer.addVertexWithUV(maxX, minY, maxZ, 0, 1);
	...
	private void renderLine(double relativeX1, double relativeY1, double relativeX2, double relativeY2) {
		...
		GL11.glLineWidth(2);
		renderer.addVertex(relativeX1, relativeY1, 0.5);
		renderer.addVertex(relativeX2, relativeY2, 0.5);
	...
	private void renderInside(TileEntity tile) {
		...
		renderer.addVertexWithUV(0.001, 0.001, 0.001, 0, 0);
		renderer.addVertexWithUV(0.999, 0.001, 0.001, 0, 1);
		renderer.addVertexWithUV(0.999, 0.999, 0.001, 1, 1);
		renderer.addVertexWithUV(0.001, 0.999, 0.001, 1, 0);
		
		renderer.addVertexWithUV(0.001, 0.001, 0.999, 0, 0);
		renderer.addVertexWithUV(0.001, 0.999, 0.999, 1, 0);
		renderer.addVertexWithUV(0.999, 0.999, 0.999, 1, 1);
		renderer.addVertexWithUV(0.999, 0.001, 0.999, 0, 1);
		
		renderer.addVertexWithUV(0.001, 0.001, 0.001, 0, 0);
		renderer.addVertexWithUV(0.001, 0.001, 0.999, 0, 1);
		renderer.addVertexWithUV(0.999, 0.001, 0.999, 1, 1);
		renderer.addVertexWithUV(0.999, 0.001, 0.001, 1, 0);
		
		renderer.addVertexWithUV(0.001, 0.999, 0.001, 0, 0);
		renderer.addVertexWithUV(0.999, 0.999, 0.001, 1, 0);
		renderer.addVertexWithUV(0.999, 0.999, 0.999, 1, 1);
		renderer.addVertexWithUV(0.001, 0.999, 0.999, 0, 1);
		
		renderer.addVertexWithUV(0.001, 0.001, 0.001, 0, 0);
		renderer.addVertexWithUV(0.001, 0.999, 0.001, 0, 1);
		renderer.addVertexWithUV(0.001, 0.999, 0.999, 1, 1);
		renderer.addVertexWithUV(0.001, 0.001, 0.999, 1, 0);
		
		renderer.addVertexWithUV(0.999, 0.001, 0.001, 0, 0);
		renderer.addVertexWithUV(0.999, 0.001, 0.999, 1, 0);
		renderer.addVertexWithUV(0.999, 0.999, 0.999, 1, 1);
		renderer.addVertexWithUV(0.999, 0.999, 0.001, 0, 1);
...
/*	private static FloatBuffer colorBuffer = GLAllocation.createDirectFloatBuffer(16);
	...
	public Vec3 getAdjustedDegrees(Vec3 vector, double rotationZ, double rotationY) {
		
		if(flag2 == false) {
			AlmagestCore.log("Original A is %s.", vector.xCoord);
			AlmagestCore.log("Original D is %s.", vector.yCoord);
			AlmagestCore.log("Original Z is %s.", rotationZ);
			AlmagestCore.log("Original Y is %s.", rotationY);
		}

		double radianA = Math.toRadians(vector.xCoord);
		double radianD = Math.toRadians(vector.yCoord);
		...
		flag2 = true;
		return new Vec3(Math.toDegrees(resRadianA), Math.toDegrees(resRadianD), 1);
